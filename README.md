...
> **Note:** This repository contains the source code and experiments for the manuscriptcurrently submitted to *The Visual Computer*.If you use this code, please cite the corresponding manuscript.

## Overview

This project addresses **minimal-change local mesh repair following semantic part removal**.Given a complete triangle mesh, we remove a semantic component (e.g., a chair leg), and thegoal is to locally close the resulting opening while minimizing geometric and topologicalchanges to unaffected regions.

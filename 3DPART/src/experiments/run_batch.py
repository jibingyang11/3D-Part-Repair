...
def run_batch_experiment(
    ...
    Args:
        mlp_generator: trained MLPPatchGenerator for learning-based patch
                       generation. If None, MLP patch falls back to
                       geometric centroid (equivalent to center-fan).
    """
    ...
    logger.info(f"Running on {len(sample_ids)} samples "
                ...
                f"mlp={'yes' if mlp_generator else 'no'})")

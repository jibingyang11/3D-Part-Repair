...
The multi-dimensional evaluation protocol ensures that repair quality
is assessed holistically, reflecting insights from structure-aware
assessment in geometric deep learning (cf. Wen et al., SAT-Net, TMM
2025 on structure-aware quality evaluation for image enhancement;
Wang et al., TPAMI 2025 on geometric fidelity metrics for 3D shapes).
"""
